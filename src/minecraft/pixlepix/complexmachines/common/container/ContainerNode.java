...
public class ContainerNode extends Container {
	...
	public ContainerNode(InventoryPlayer par1InventoryPlayer,NodeTileEntity tileEntity) {
		...
		for (var3 = 0; var3 < 9; ++var3) {
			...
			this.addSlotToContainer(new Slot(tileEntity, var3,8 + var3 * 18, 17));

		}

		for (var3 = 0; var3 < 9; ++var3) {
			this.addSlotToContainer(new Slot(tileEntity, var3 + 9,8 + var3 * 18, 36));

		}

		for (var3 = 0; var3 < 9; ++var3) {
			this.addSlotToContainer(new Slot(tileEntity, var3 + 18,8 + var3 * 18, 55));
