...
public class RenderFocalPoint extends TileEntitySpecialRenderer
{
    private FocalPointModel model;
    
    public RenderFocalPoint()
    {
    ...
    {
        this.bindTextureByName("/mods/ComplexMachines/textures/models/FocalPoint.png");
        GL11.glPushMatrix();
