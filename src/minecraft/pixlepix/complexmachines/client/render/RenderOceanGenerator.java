...
public class RenderOceanGenerator extends TileEntitySpecialRenderer
{
    private OceanGeneratorModel model;
    
    public RenderOceanGenerator()
    {
    ...
    {
        this.bindTextureByName("/mods/ComplexMachines/textures/models/OceanGenerator.png");
        GL11.glPushMatrix();
