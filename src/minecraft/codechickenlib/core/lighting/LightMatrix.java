package codechickenlib.core.lighting;

import codechickenlib.core.render.CCModel;
import codechickenlib.core.render.CCRenderState;
import codechickenlib.core.render.IVertexModifier;
import codechickenlib.core.render.UV;
import codechickenlib.core.vec.BlockCoord;
...
public class LightMatrix implements IVertexModifier
{
    ...
    public void applyModifiers(CCModel m, Tessellator tess, Vector3 vec, UV uv, Vector3 normal, int i)
    {
        ...
        setColour(tess, lc, m.colours == null ? -1 : m.colours[i]);
